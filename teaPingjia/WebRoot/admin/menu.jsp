	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              ...
	              <li><a href='<%=path %>/admin/stu/stuSearch.jsp' target='main'>学生查询</a> </li>
	              <li><a href='<%=path %>/admin/stu/stuAdd.jsp' target='main'>学生录入</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>老师管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              <li><a href='<%=path %>/teaMana.action' target='main'>老师管理</a> </li>
	              <li><a href='<%=path %>/admin/tea/teaSearch.jsp' target='main'>老师查询</a> </li>
	              <li><a href='<%=path %>/admin/tea/teaAdd.jsp' target='main'>老师录入</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	              ...
	              <li><a href='<%=path %>/admin/yijizhibiao/yijizhibiaoAdd.jsp' target='main'>一级指标录入</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <!-- 1 -->
